    ...
    return (
        <footer className={style.footer}>
            <div className={style.footer_upper}>
                <div>
                    <span>support@iboplayerapp.de</span>
                    <span>+971563163317</span>
                </div>
                <div>
                    <a><img src={"/assets/ibo-player-logo.png"} alt="ibo player logo" /></a>
                </div>
                <div>
                    <a href={"#"}>
                        <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 512 512"
                             height="1.4rem"
                             width="1.4rem" xmlns="http://www.w3.org/2000/svg">
                            <path
            ...
            <div className={style.footer_lower}>
                <p>Copyright © 2025 IBO Player Company</p>
